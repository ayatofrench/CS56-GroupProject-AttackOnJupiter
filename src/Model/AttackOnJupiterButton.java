...
public class AttackOnJupiterButton extends Button {
	private final String FONT_PATH = "file:src/resources/Raleway.ttf";
	...
	public AttackOnJupiterButton(String text) {
		setText(text);
		setButtonFont();
		setPrefWidth(190);
		setPrefHeight(49);
